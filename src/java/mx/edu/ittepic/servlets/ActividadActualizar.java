 ...
 */
@WebServlet(name = "ActividadActualizar", urlPatterns = {"/ActividadActualizar"})
public class ActividadActualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActividadActualizar</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActividadActualizar at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        p.write(ejb.actualizarActividad(idactividad, nombreactividad,imgactividad,descriactividad, tiempoactividad, transporteactividad, entradaactividad, intinerarioactividad, audioguiaactividad, toursinentradaactividad, importanteactividad, accesibilidadactividad, precioadutoactiviadad, precioninoactividad, puntoactividad  ));
